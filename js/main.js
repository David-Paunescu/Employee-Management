let empFromLocalStorage= [];
let employeesArr = [];
////////////////////////////////////////////////////////////////////////
console.log('employeesArr first', employeesArr);
...
function checkUserLogin() {
    ...
    if (userLoggedIn !== 'logged') {
        ...
        if (localStorage.length !== 0) {
            empFromLocalStorage = localStorage.getItem('employeesArr');
            employeesArr = JSON.parse(empFromLocalStorage);
        };
...
/////////////////////////////////////////////////////////////////////////
console.log('employeesArr second', employeesArr );
function createTable() {
    ...
    ////////////////////////////////////////////////////////////////////
        console.log('employeesArr third',employeesArr );
...
function createRow(person, i) {
    ...
    rowStr += '<td><button class="editButton" onclick="editEmp(' + i + ')">Edit</button><button class="deleteButton" onclick="deleteEmp(' + i + ')">Del</button></td>';
    rowStr += '</tr>';
    return rowStr;
}
...
function cancelAddForm() {
    const userConfirm = confirm('Are you sure you want to cancel adding a new user?')
